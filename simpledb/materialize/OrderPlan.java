...
public class OrderPlan implements Plan {
   ...
   private Schema sch;
   private OrderRecordComparator comp;
   private List<Boolean> desc;
    ...
    */
   public OrderPlan(Plan p, List<String> sortfields, List<Boolean> desc, Transaction tx) {
      this.p = p;
      this.tx = tx;
      this.desc = desc;
      sch = p.schema();
      comp = new OrderRecordComparator(sortfields,desc);
   }
   ...
   public Scan open() {
      ...
      return new OrderScan(runs, comp);
   }
